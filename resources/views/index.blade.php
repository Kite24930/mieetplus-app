...
{{--    </header>--}}
    <main>
        <div id="main-visual" class="w-full h-auto min-h-screen flex flex-col justify-center items-center pb-12 md:pb-0">
            ...
            <div class="w-full flex flex-col gap-6 py-4 justify-center items-center px-4">
                <div class="md:text-6xl text-2xl font-bold">Mieet Plus 閉鎖のご案内</div>
                <div>
